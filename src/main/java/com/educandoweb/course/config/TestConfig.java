...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o5 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u3);
		Order o6 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u4);
		Order o7 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u1);
		Order o8 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u2);
		Order o9 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u3);
		Order o10 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u4);
